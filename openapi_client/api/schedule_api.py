...
class ScheduleApi(object):
    ...
    def api_schedule_for_room_room_name_get(self, room_name, **kwargs):  # noqa: E501
        """api_schedule_for_room_room_name_get  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_schedule_for_room_room_name_get(room_name, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str room_name: (required)
        :param datetime start_utc:
        :param datetime end_utc:
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.api_schedule_for_room_room_name_get_with_http_info(room_name, **kwargs)  # noqa: E501

    def api_schedule_for_room_room_name_get_with_http_info(self, room_name, **kwargs):  # noqa: E501
        """api_schedule_for_room_room_name_get  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_schedule_for_room_room_name_get_with_http_info(room_name, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['room_name', 'start_utc', 'end_utc']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_schedule_for_room_room_name_get" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if ('room_name' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `room_name` when calling `api_schedule_for_room_room_name_get`")  # noqa: E501
        ...
        query_params = []
        if 'start_utc' in local_var_params:
            query_params.append(('startUtc', local_var_params['start_utc']))  # noqa: E501
        if 'end_utc' in local_var_params:
            query_params.append(('endUtc', local_var_params['end_utc']))  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/Schedule/ForRoom/{roomName}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api_schedule_get_rooms_get(self, **kwargs):  # noqa: E501
        """api_schedule_get_rooms_get  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_schedule_get_rooms_get(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.api_schedule_get_rooms_get_with_http_info(**kwargs)  # noqa: E501

    def api_schedule_get_rooms_get_with_http_info(self, **kwargs):  # noqa: E501
        """api_schedule_get_rooms_get  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_schedule_get_rooms_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_schedule_get_rooms_get" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
